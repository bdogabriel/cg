...
static const Binding bindings[] = {
    ...
    {Mode::ANY, GLFW_KEY_W, 0, true, [](EditorState &s, DrawBuffer &, const Input &) { s.wireframe = !s.wireframe; }},
    ...
    {Mode::ROTATE,   GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { buf.transforms[s.selectedRef].r = s.cfg.rotateYNeg * buf.transforms[s.selectedRef].r; }},
    ...
    {Mode::ROTATE_Y, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { buf.transforms[s.selectedRef].r = buf.transforms[s.selectedRef].r * s.cfg.rotateY;    }},
    {Mode::ROTATE_Z, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { buf.transforms[s.selectedRef].r = buf.transforms[s.selectedRef].r * s.cfg.rotateZNeg; }},
    {Mode::ROTATE_Z, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { buf.transforms[s.selectedRef].r = buf.transforms[s.selectedRef].r * s.cfg.rotateZ;    }},
    ...
    {Mode::TRANSLATE_FACE,   GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.translateXNeg); }},
    ...
    {Mode::TRANSLATE_FACE_Y, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.translateY);    }},
    {Mode::TRANSLATE_FACE_Z, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.translateZNeg); }},
    {Mode::TRANSLATE_FACE_Z, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.translateZ);    }},

    {Mode::ROTATE_FACE,   GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.rotateYNeg); }},
    ...
    {Mode::ROTATE_FACE_Y, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.rotateY);    }},
    {Mode::ROTATE_FACE_Z, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.rotateZNeg); }},
    {Mode::ROTATE_FACE_Z, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.rotateZ);    }},

    {Mode::SCALE_FACE,   GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.scaleXNeg); }},
    ...
    {Mode::SCALE_FACE_Y, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.scaleY);    }},
    {Mode::SCALE_FACE_Z, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.scaleZNeg); }},
    {Mode::SCALE_FACE_Z, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.scaleZ);    }},

    {Mode::SHEAR_FACE_X, GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearXYNeg); }},
    {Mode::SHEAR_FACE_X, GLFW_KEY_L, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearXY);    }},
    {Mode::SHEAR_FACE_X, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearXZNeg); }},
    {Mode::SHEAR_FACE_X, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearXZ);    }},
    {Mode::SHEAR_FACE_Y, GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearYXNeg); }},
    {Mode::SHEAR_FACE_Y, GLFW_KEY_L, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearYX);    }},
    {Mode::SHEAR_FACE_Y, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearYZNeg); }},
    {Mode::SHEAR_FACE_Y, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearYZ);    }},
    {Mode::SHEAR_FACE_Z, GLFW_KEY_H, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearZXNeg); }},
    {Mode::SHEAR_FACE_Z, GLFW_KEY_L, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearZX);    }},
    {Mode::SHEAR_FACE_Z, GLFW_KEY_J, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearZYNeg); }},
    {Mode::SHEAR_FACE_Z, GLFW_KEY_K, 0, false, [](EditorState &s, DrawBuffer &buf, const Input &) { transform_active_faces(s, buf, s.cfg.shearZY);    }},
